...
var file_note_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4e, 0x6f, 0x74, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04,
	...
	0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6e, 0x6f, 0x74, 0x65, 0x2e, 0x76,
	...
	0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6e, 0x6f, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70,
	...
	,
	...
	0x6c, 0x65, 0x74, 0x65, 0x12, 0x16, 0x2e, 0x6e, 0x6f, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x44,
	...
	0x6f, 0x6d, 0x2f, 0x72, 0x65, 0x6a, 0x61, 0x6d, 0x65, 0x74, 0x6f, 0x76, 0x2f, 0x67, 0x6f, 0x2d,
	0x74, 0x75, 0x74, 0x6f, 0x72, 0x69, 0x61, 0x6c, 0x73, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70,
	0x6b, 0x67, 0x2f, 0x6e, 0x6f, 0x74, 0x65, 0x2f, 0x76, 0x31, 0x3b, 0x6e, 0x6f, 0x74, 0x65, 0x5f,
...
var file_note_proto_goTypes = []interface{}{
	(*NoteInfo)(nil),               // 0: note.v1.NoteInfo
	(*Note)(nil),                   // 1: note.v1.Note
	(*UpdateNoteInfo)(nil),         // 2: note.v1.UpdateNoteInfo
	(*CreateRequest)(nil),          // 3: note.v1.CreateRequest
	(*CreateResponse)(nil),         // 4: note.v1.CreateResponse
	(*GetRequest)(nil),             // 5: note.v1.GetRequest
	(*GetResponse)(nil),            // 6: note.v1.GetResponse
	(*ListRequest)(nil),            // 7: note.v1.ListRequest
	(*ListResponse)(nil),           // 8: note.v1.ListResponse
	(*UpdateRequest)(nil),          // 9: note.v1.UpdateRequest
	(*DeleteRequest)(nil),          // 10: note.v1.DeleteRequest
...
var file_note_proto_depIdxs = []int32{
	0,  // 0: note.v1.Note.info:type_name -> note.v1.NoteInfo
	11, // 1: note.v1.Note.created_at:type_name -> google.protobuf.Timestamp
	11, // 2: note.v1.Note.updated_at:type_name -> google.protobuf.Timestamp
	12, // 3: note.v1.UpdateNoteInfo.title:type_name -> google.protobuf.StringValue
	12, // 4: note.v1.UpdateNoteInfo.context:type_name -> google.protobuf.StringValue
	12, // 5: note.v1.UpdateNoteInfo.author:type_name -> google.protobuf.StringValue
	13, // 6: note.v1.UpdateNoteInfo.is_public:type_name -> google.protobuf.BoolValue
	0,  // 7: note.v1.CreateRequest.info:type_name -> note.v1.NoteInfo
	1,  // 8: note.v1.GetResponse.note:type_name -> note.v1.Note
	1,  // 9: note.v1.ListResponse.notes:type_name -> note.v1.Note
	2,  // 10: note.v1.UpdateRequest.info:type_name -> note.v1.UpdateNoteInfo
	3,  // 11: note.v1.NoteV1.Create:input_type -> note.v1.CreateRequest
	5,  // 12: note.v1.NoteV1.Get:input_type -> note.v1.GetRequest
	7,  // 13: note.v1.NoteV1.List:input_type -> note.v1.ListRequest
	9,  // 14: note.v1.NoteV1.Update:input_type -> note.v1.UpdateRequest
	10, // 15: note.v1.NoteV1.Delete:input_type -> note.v1.DeleteRequest
	4,  // 16: note.v1.NoteV1.Create:output_type -> note.v1.CreateResponse
	6,  // 17: note.v1.NoteV1.Get:output_type -> note.v1.GetResponse
	8,  // 18: note.v1.NoteV1.List:output_type -> note.v1.ListResponse
	14, // 19: note.v1.NoteV1.Update:output_type -> google.protobuf.Empty
	14, // 20: note.v1.NoteV1.Delete:output_type -> google.protobuf.Empty
